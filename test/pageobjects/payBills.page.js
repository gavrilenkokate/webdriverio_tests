...
class payBillsPage extends Page {
	...
	get selectedCurrencyRadioBtn() {
		return $('#pc_inDollars_false')
	}
	get calculateCostsBtn() {
	...
	get purchaseForeignCurrencyTabLink() {
		return $('a[href="#ui-tabs-3"]')
	}
	get purchaseCurrencyForm() {
	...
	selectRandomCurrency() {
		...
		let randomCurrencyIdx = Math.floor(
			Math.random() * (numberOfOptions - 1) + 1
		)
